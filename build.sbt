  ...
  .settings(
    inThisBuild(
      List(
        ...
        (enableDecimalLogicalType in AvroConfig) := true,
        (fieldVisibility in AvroConfig) := "private",
        libraryDependencies ++= Seq(
          ...
          "org.scalaz"       %% "scalaz-scalacheck-binding" % versions.scalazTest % Test,
        )
      )
    ),
    name := "evolution"
  )
  .aggregate(commons, producer, productStats, recommender)
